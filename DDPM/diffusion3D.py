...
"""
Code was taken from https://github.com/lucidrains/denoising-diffusion-pytorch and modified for 3D version.
"""
...
class Block(nn.Module):
    def __init__(self, dim, dim_out, groups=8):
        ...
        self.block = nn.Sequential(
            nn.Conv3d(dim, dim_out, 3, padding='same', bias=False),
...
def Downsample():
    return nn.AvgPool3d(kernel_size=3, stride=2, padding=1)
...
class Unet(nn.Module):
    def __init__(
        ...
        self.init_conv = nn.Conv3d(channels, init_dim, 7, padding='same', bias=False)
